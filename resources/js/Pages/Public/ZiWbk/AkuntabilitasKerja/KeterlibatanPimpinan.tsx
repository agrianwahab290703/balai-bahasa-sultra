...
import { 
    ChevronRight, ArrowLeft, Crown, FileText, FolderOpen, CheckCircle2, Shield, X, Loader2, ExternalLink, ChevronDown, ClipboardList, Target, BarChart3
} from 'lucide-react';
...
const documentIcons = [ClipboardList, Target, BarChart3];
                ...
                <div className="flex items-center justify-between px-6 py-4 border-b border-gray-100 bg-gradient-to-r from-slate-50 to-white">
                    <div className="flex items-center gap-3">
                        ...
                        <div>
                            ...
                            <p className="text-sm text-gray-500">Dokumen Keterlibatan Pimpinan</p>
                        </div>
                    </div>
                ...
                <div className="p-6 cursor-pointer" onClick={() => setIsExpanded(!isExpanded)}>
                    <div className="flex items-start gap-4">
                        ...
                        <div className="flex-1 min-w-0">
                            ...
                            <h3 className="text-base lg:text-lg font-semibold text-gray-900 leading-relaxed group-hover:text-amber-600 transition-colors">{document.title}</h3>
...
export default function KeterlibatanPimpinan({ documents }: Props) {
    const [selectedDocument, setSelectedDocument] = useState<DocumentItem | null>(null);

    return (
        <PublicLayout title="Keterlibatan Pimpinan - ZI-WBK" description="Keterlibatan Pimpinan dalam Akuntabilitas Kerja">
            <section className="relative bg-gradient-to-br from-[#d97706] via-[#b45309] to-[#92400e] py-16 lg:py-20 overflow-hidden">
                ...
                <div className="container relative mx-auto px-4">
                    <div className="max-w-4xl mx-auto">
                        <div className="flex items-center gap-2 text-amber-200 mb-6 text-sm flex-wrap">
                            ...
                            <ChevronRight className="h-4 w-4" />
                            <span className="text-white">Keterlibatan Pimpinan</span>
                        </div>
                        <div className="flex items-start gap-6">
                            ...
                            <div>
                                ...
                                <h1 className="text-3xl font-bold text-white sm:text-4xl lg:text-5xl mb-4">
                                    Keterlibatan <span className="font-display italic text-yellow-400">Pimpinan</span>
                                </h1>
                                <p className="text-lg text-amber-100/90 max-w-2xl leading-relaxed">
                                    Keterlibatan pimpinan dalam penyusunan perencanaan dan pemantauan kinerja.
                                </p>
                            </div>
                        </div>
                    </div>
                            ...
                            <Card className="border-0 shadow-lg bg-gradient-to-br from-amber-50 to-white overflow-hidden">
                                <CardContent className="p-6 lg:p-8">
                                    <div className="flex items-start gap-4">
                                        ...
                                        <div>
                                            <h2 className="text-xl font-bold text-gray-900 mb-2">Dokumen Keterlibatan Pimpinan</h2>
                                            <p className="text-gray-600 leading-relaxed">
                                                Dokumen terkait keterlibatan pimpinan dalam perencanaan dan pemantauan kinerja.
                                            </p>
                                        </div>
                                    </div>
                                </CardContent>
                            ...
                            <Card className="border-0 shadow-lg bg-gradient-to-br from-gray-50 to-white">
                                <CardContent className="p-6">
                                    <div className="flex items-start gap-4">
                                        ...
                                        <div>
                                            <h3 className="font-semibold text-gray-900 mb-1">Kepemimpinan Aktif</h3>
                                            <p className="text-sm text-gray-600 leading-relaxed">
                                                Keterlibatan aktif pimpinan dalam perencanaan dan pemantauan kinerja mendukung pencapaian target organisasi.
                                            </p>
                                        </div>
                                    </div>
                                </CardContent>
                ...
                <div className="container mx-auto px-4">
                    <div className="max-w-4xl mx-auto">
                        <div className="flex flex-col sm:flex-row items-center justify-between gap-4">
                            ...
                            <Link href="/zi-wbk/akuntabilitas-kerja/pengelolaan-akuntabilitas"><Button className="gap-2 bg-amber-600 hover:bg-amber-700">Pengelolaan Akuntabilitas<ChevronRight className="w-4 h-4" /></Button></Link>
                        </div>
                    </div>
                </div>
            </section>
