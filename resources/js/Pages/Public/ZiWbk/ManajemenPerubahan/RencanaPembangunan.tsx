...
interface RencanaPembangunanProps {
    documents: DocumentItem[];
}

// Icons for each document type
const documentIcons = [ClipboardList, BarChart3, Megaphone];
                ...
                <div className="flex items-center justify-between px-6 py-4 border-b border-gray-100 bg-gradient-to-r from-slate-50 to-white">
                    <div className="flex items-center gap-3">
                        ...
                        <div>
                            ...
                            <p className="text-sm text-gray-500">Dokumen Rencana Pembangunan</p>
                        </div>
                    </div>
                    <button
                        onClick={onClose}
...
// Document Card Component with unique styling per item
const DocumentCard = ({ 
    document, 
    index, 
    onViewDocuments 
    ...
    // Different color schemes for visual variety
    const colorSchemes = [
                ...
                >
                    <div className="flex items-start gap-4">
                        ...
                        <div className="flex-1 min-w-0">
                            ...
                            <h3 className="text-base lg:text-lg font-semibold text-gray-900 leading-relaxed group-hover:text-emerald-600 transition-colors">
                                {document.title}
                            </h3>
...
export default function RencanaPembangunan({ documents }: RencanaPembangunanProps) {
    const [selectedDocument, setSelectedDocument] = useState<DocumentItem | null>(null);

    return (
        <PublicLayout 
            title="Rencana Pembangunan WBK - ZI-WBK" 
            description="Rencana Kerja Pembangunan Zona Integritas menuju WBK/WBBM"
        >
            {/* Hero Section */}
            <section className="relative bg-gradient-to-br from-[#047857] via-[#059669] to-[#10b981] py-16 lg:py-20 overflow-hidden">
                {/* Decorative elements */}
                ...
                <div className="container relative mx-auto px-4">
                    <div className="max-w-4xl mx-auto">
                        ...
                        <div className="flex items-center gap-2 text-emerald-200 mb-6 text-sm flex-wrap">
                            ...
                            <ChevronRight className="h-4 w-4" />
                            <span className="text-white">Rencana Pembangunan</span>
                        </div>
                        ...
                        <div className="flex items-start gap-6">
                            ...
                            <div>
                                ...
                                <h1 className="text-3xl font-bold text-white sm:text-4xl lg:text-5xl mb-4">
                                    Rencana Pembangunan <span className="font-display italic text-yellow-400">WBK</span>
                                </h1>
                                <p className="text-lg text-emerald-100/90 max-w-2xl leading-relaxed">
                                    Dokumen rencana kerja, target prioritas, dan mekanisme sosialisasi 
                            ...
                            <Card className="border-0 shadow-lg bg-gradient-to-br from-emerald-50 to-white overflow-hidden">
                                <CardContent className="p-6 lg:p-8">
                                    <div className="flex items-start gap-4">
                                        ...
                                        <div>
                                            <h2 className="text-xl font-bold text-gray-900 mb-2">Dokumen Rencana Pembangunan</h2>
                                            <p className="text-gray-600 leading-relaxed">
                                                Berikut adalah dokumen terkait rencana kerja, target prioritas, dan 
                                                mekanisme sosialisasi pembangunan Zona Integritas. Klik pada setiap 
                                                kriteria untuk melihat dokumen pendukung.
                                            </p>
                                        </div>
                                    </div>
                                </CardContent>
                        ...
                        <div className="mt-10 grid sm:grid-cols-3 gap-4">
                            <Card className="border-0 shadow-md bg-gradient-to-br from-emerald-50 to-white">
                                <CardContent className="p-5 text-center">
                                    ...
                                    <p className="text-sm font-medium text-gray-600">Rencana Kerja</p>
                                    <p className="text-xs text-gray-400 mt-1">Dokumen perencanaan</p>
                                </CardContent>
                            </Card>
                            <Card className="border-0 shadow-md bg-gradient-to-br from-blue-50 to-white">
                                <CardContent className="p-5 text-center">
                                    <BarChart3 className="w-8 h-8 text-blue-600 mx-auto mb-2" />
                                    <p className="text-sm font-medium text-gray-600">Target Prioritas</p>
                                    <p className="text-xs text-gray-400 mt-1">Capaian terukur</p>
                                </CardContent>
                            </Card>
                            <Card className="border-0 shadow-md bg-gradient-to-br from-amber-50 to-white">
                                <CardContent className="p-5 text-center">
                                    ...
                                    <p className="text-sm font-medium text-gray-600">Sosialisasi</p>
                                    <p className="text-xs text-gray-400 mt-1">Media informasi</p>
                                </CardContent>
                            </Card>
                        </div>
                            ...
                            <Card className="border-0 shadow-lg bg-gradient-to-br from-gray-50 to-white">
                                <CardContent className="p-6">
                                    <div className="flex items-start gap-4">
                                        ...
                                        <div>
                                            <h3 className="font-semibold text-gray-900 mb-1">Perencanaan Strategis</h3>
                                            <p className="text-sm text-gray-600 leading-relaxed">
                                                Rencana pembangunan Zona Integritas disusun secara sistematis dengan 
                                                target yang terukur dan mekanisme sosialisasi yang efektif untuk 
                                                memastikan tercapainya Wilayah Bebas dari Korupsi (WBK).
                                            </p>
                                        </div>
                                    </div>
                                </CardContent>
                ...
                <div className="container mx-auto px-4">
                    <div className="max-w-4xl mx-auto">
                        <div className="flex flex-col sm:flex-row items-center justify-between gap-4">
                            <Link href="/zi-wbk/manajemen-perubahan/tim-kerja">
