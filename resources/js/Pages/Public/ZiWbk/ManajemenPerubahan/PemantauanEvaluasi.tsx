...
interface PemantauanEvaluasiProps {
    documents: DocumentItem[];
}

// Icons for each document type
const documentIcons = [ListChecks, BarChart2, CheckSquare];
                ...
                <div className="flex items-center justify-between px-6 py-4 border-b border-gray-100 bg-gradient-to-r from-slate-50 to-white">
                    <div className="flex items-center gap-3">
                        ...
                        <div>
                            ...
                            <p className="text-sm text-gray-500">Dokumen Pemantauan & Evaluasi</p>
                        </div>
                    </div>
                    <button
                        onClick={onClose}
                ...
                >
                    <div className="flex items-start gap-4">
                        ...
                        <div className="flex-1 min-w-0">
                            ...
                            <h3 className="text-base lg:text-lg font-semibold text-gray-900 leading-relaxed group-hover:text-indigo-600 transition-colors">
                                {document.title}
                            </h3>
...
export default function PemantauanEvaluasi({ documents }: PemantauanEvaluasiProps) {
    const [selectedDocument, setSelectedDocument] = useState<DocumentItem | null>(null);

    return (
        <PublicLayout 
            title="Pemantauan & Evaluasi - ZI-WBK" 
            description="Pemantauan dan Evaluasi Pembangunan Zona Integritas menuju WBK/WBBM"
        >
            {/* Hero Section */}
            <section className="relative bg-gradient-to-br from-[#4338ca] via-[#5b21b6] to-[#6d28d9] py-16 lg:py-20 overflow-hidden">
                {/* Decorative elements */}
                ...
                <div className="container relative mx-auto px-4">
                    <div className="max-w-4xl mx-auto">
                        ...
                        <div className="flex items-center gap-2 text-indigo-200 mb-6 text-sm flex-wrap">
                            ...
                            <ChevronRight className="h-4 w-4" />
                            <span className="text-white">Pemantauan & Evaluasi</span>
                        </div>
                        ...
                        <div className="flex items-start gap-6">
                            ...
                            <div>
                                ...
                                <h1 className="text-3xl font-bold text-white sm:text-4xl lg:text-5xl mb-4">
                                    Pemantauan & <span className="font-display italic text-yellow-400">Evaluasi</span>
                                </h1>
                                <p className="text-lg text-indigo-100/90 max-w-2xl leading-relaxed">
                                    Monitoring dan evaluasi terhadap pelaksanaan pembangunan 
                            ...
                            <Card className="border-0 shadow-lg bg-gradient-to-br from-indigo-50 to-white overflow-hidden">
                                <CardContent className="p-6 lg:p-8">
                                    <div className="flex items-start gap-4">
                                        ...
                                        <div>
                                            <h2 className="text-xl font-bold text-gray-900 mb-2">Dokumen Pemantauan & Evaluasi</h2>
                                            <p className="text-gray-600 leading-relaxed">
                                                Berikut adalah dokumen terkait monitoring dan evaluasi pembangunan 
                                                Zona Integritas. Klik pada setiap kriteria untuk melihat dokumen pendukung.
                                            </p>
                                        </div>
                                    </div>
                                </CardContent>
                        ...
                        <div className="mt-10 grid sm:grid-cols-3 gap-4">
                            <Card className="border-0 shadow-md bg-gradient-to-br from-indigo-50 to-white">
                                <CardContent className="p-5 text-center">
                                    <ListChecks className="w-8 h-8 text-indigo-600 mx-auto mb-2" />
                                    <p className="text-sm font-medium text-gray-600">Pelaksanaan</p>
                                    <p className="text-xs text-gray-400 mt-1">Kesesuaian rencana</p>
                                </CardContent>
                            </Card>
                            <Card className="border-0 shadow-md bg-gradient-to-br from-violet-50 to-white">
                                <CardContent className="p-5 text-center">
                                    <BarChart2 className="w-8 h-8 text-violet-600 mx-auto mb-2" />
                                    <p className="text-sm font-medium text-gray-600">Monitoring</p>
                                    <p className="text-xs text-gray-400 mt-1">Evaluasi berkala</p>
                                </CardContent>
                            </Card>
                            <Card className="border-0 shadow-md bg-gradient-to-br from-teal-50 to-white">
                                <CardContent className="p-5 text-center">
                                    <CheckSquare className="w-8 h-8 text-teal-600 mx-auto mb-2" />
                                    <p className="text-sm font-medium text-gray-600">Tindak Lanjut</p>
                                    <p className="text-xs text-gray-400 mt-1">Hasil evaluasi</p>
                                </CardContent>
                            </Card>
                        </div>
                            ...
                            <Card className="border-0 shadow-lg bg-gradient-to-br from-gray-50 to-white">
                                <CardContent className="p-6">
                                    <div className="flex items-start gap-4">
                                        ...
                                        <div>
                                            <h3 className="font-semibold text-gray-900 mb-1">Siklus Pemantauan & Evaluasi</h3>
                                            <p className="text-sm text-gray-600 leading-relaxed">
                                                Pemantauan dan evaluasi dilakukan secara berkala untuk memastikan 
                                                pembangunan Zona Integritas berjalan sesuai rencana dan hasil evaluasi 
                                                ditindaklanjuti dengan tepat untuk perbaikan berkelanjutan.
                                            </p>
                                        </div>
                                    </div>
                                </CardContent>
                ...
                <div className="container mx-auto px-4">
                    <div className="max-w-4xl mx-auto">
                        <div className="flex flex-col sm:flex-row items-center justify-between gap-4">
                            ...
                            <Link href="/zi-wbk/manajemen-perubahan/perubahan-pola-pikir">
