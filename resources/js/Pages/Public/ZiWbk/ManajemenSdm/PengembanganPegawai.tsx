...
import { 
    ChevronRight, ArrowLeft, GraduationCap, FileText, FolderOpen, CheckCircle2, Shield, X, Loader2, ExternalLink, ChevronDown, BookOpen, Target, Award, Users, Lightbulb, ClipboardCheck
} from 'lucide-react';
...
const documentIcons = [BookOpen, Target, Award, Users, Lightbulb, ClipboardCheck];
                ...
                <div className="flex items-center justify-between px-6 py-4 border-b border-gray-100 bg-gradient-to-r from-slate-50 to-white">
                    <div className="flex items-center gap-3">
                        ...
                        <div>
                            ...
                            <p className="text-sm text-gray-500">Dokumen Pengembangan Pegawai</p>
                        </div>
                    </div>
...
export default function PengembanganPegawai({ documents }: Props) {
    const [selectedDocument, setSelectedDocument] = useState<DocumentItem | null>(null);

    return (
        <PublicLayout title="Pengembangan Pegawai Berbasis Kompetensi - ZI-WBK" description="Pengembangan Pegawai Berbasis Kompetensi">
            <section className="relative bg-gradient-to-br from-[#6366f1] via-[#4f46e5] to-[#4338ca] py-16 lg:py-20 overflow-hidden">
                ...
                <div className="container relative mx-auto px-4">
                    <div className="max-w-4xl mx-auto">
                        <div className="flex items-center gap-2 text-indigo-200 mb-6 text-sm flex-wrap">
                            ...
                            <ChevronRight className="h-4 w-4" />
                            <span className="text-white">Pengembangan Pegawai</span>
                        </div>
                        <div className="flex items-start gap-6">
                            ...
                            <div>
                                ...
                                <h1 className="text-3xl font-bold text-white sm:text-4xl lg:text-5xl mb-4">
                                    Pengembangan Pegawai <span className="font-display italic text-yellow-400">Berbasis Kompetensi</span>
                                </h1>
                                <p className="text-lg text-indigo-100/90 max-w-2xl leading-relaxed">
                                    Pengembangan kompetensi pegawai melalui training, coaching, dan mentoring.
                                </p>
                            </div>
                        </div>
                    </div>
                            ...
                            <Card className="border-0 shadow-lg bg-gradient-to-br from-indigo-50 to-white overflow-hidden">
                                <CardContent className="p-6 lg:p-8">
                                    <div className="flex items-start gap-4">
                                        ...
                                        <div>
                                            <h2 className="text-xl font-bold text-gray-900 mb-2">Dokumen Pengembangan Pegawai</h2>
                                            <p className="text-gray-600 leading-relaxed">
                                                Dokumen terkait pengembangan kompetensi pegawai berbasis kebutuhan dan kinerja.
                                            </p>
                                        </div>
                                    </div>
                                </CardContent>
                            ...
                            <Card className="border-0 shadow-lg bg-gradient-to-br from-gray-50 to-white">
                                <CardContent className="p-6">
                                    <div className="flex items-start gap-4">
                                        ...
                                        <div>
                                            <h3 className="font-semibold text-gray-900 mb-1">Peningkatan Kompetensi</h3>
                                            <p className="text-sm text-gray-600 leading-relaxed">
                                                Pengembangan pegawai berbasis kompetensi mendukung peningkatan kinerja dan profesionalisme SDM.
                                            </p>
                                        </div>
                                    </div>
                                </CardContent>
                ...
                <div className="container mx-auto px-4">
                    <div className="max-w-4xl mx-auto">
                        <div className="flex flex-col sm:flex-row items-center justify-between gap-4">
                            <Link href="/zi-wbk/manajemen-sdm/pola-mutasi"><Button variant="outline" className="gap-2"><ArrowLeft className="w-4 h-4" />Pola Mutasi</Button></Link>
                            <Link href="/zi-wbk/manajemen-sdm/penetapan-kinerja"><Button className="gap-2 bg-indigo-600 hover:bg-indigo-700">Penetapan Kinerja<ChevronRight className="w-4 h-4" /></Button></Link>
                        </div>
                    </div>
                </div>
            </section>
