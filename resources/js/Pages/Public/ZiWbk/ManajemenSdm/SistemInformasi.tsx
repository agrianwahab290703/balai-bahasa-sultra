...
import { 
    ChevronRight, ArrowLeft, Database, FileText, FolderOpen, CheckCircle2, Shield, X, Loader2, ExternalLink, ChevronDown, RefreshCw
} from 'lucide-react';
                ...
                <div className="flex items-center justify-between px-6 py-4 border-b border-gray-100 bg-gradient-to-r from-slate-50 to-white">
                    <div className="flex items-center gap-3">
                        ...
                        <div>
                            ...
                            <p className="text-sm text-gray-500">Dokumen Sistem Informasi</p>
                        </div>
                    </div>
...
const DocumentCard = ({ document, index, onViewDocuments }: { document: DocumentItem; index: number; onViewDocuments: (doc: DocumentItem) => void; }) => {
    ...
    const colors = { bg: 'from-sky-500 to-sky-600', shadow: 'shadow-sky-500/25', light: 'bg-sky-50', text: 'text-sky-600' };
                ...
                <div className="p-6 cursor-pointer" onClick={() => setIsExpanded(!isExpanded)}>
                    <div className="flex items-start gap-4">
                        ...
                        <div className="flex-1 min-w-0">
                            ...
                            <h3 className="text-base lg:text-lg font-semibold text-gray-900 leading-relaxed group-hover:text-sky-600 transition-colors">{document.title}</h3>
...
export default function SistemInformasi({ documents }: Props) {
    const [selectedDocument, setSelectedDocument] = useState<DocumentItem | null>(null);

    return (
        <PublicLayout title="Sistem Informasi Kepegawaian - ZI-WBK" description="Sistem Informasi Kepegawaian">
            <section className="relative bg-gradient-to-br from-[#0284c7] via-[#0369a1] to-[#075985] py-16 lg:py-20 overflow-hidden">
                <div className="absolute inset-0 overflow-hidden">
                    <div className="absolute -top-24 -right-24 w-96 h-96 bg-yellow-400/10 rounded-full blur-3xl" />
                    <div className="absolute -bottom-32 -left-32 w-[500px] h-[500px] bg-sky-300/20 rounded-full blur-3xl" />
                </div>
                ...
                <div className="container relative mx-auto px-4">
                    <div className="max-w-4xl mx-auto">
                        <div className="flex items-center gap-2 text-sky-200 mb-6 text-sm flex-wrap">
                        ...
                        <div className="flex items-start gap-6">
                            ...
                            <div>
                                ...
                                <h1 className="text-3xl font-bold text-white sm:text-4xl lg:text-5xl mb-4">
                                    Sistem Informasi <span className="font-display italic text-yellow-400">Kepegawaian</span>
                                </h1>
                                <p className="text-lg text-sky-100/90 max-w-2xl leading-relaxed">
                                    Pengelolaan dan pemutakhiran data informasi kepegawaian.
                                </p>
                            </div>
                        </div>
                    </div>
            ...
            <section className="bg-gradient-to-b from-white to-gray-50 py-12 lg:py-16">
                <div className="container mx-auto px-4">
                    <div className="max-w-4xl mx-auto">
                        <div className="mb-10">
                            <Card className="border-0 shadow-lg bg-gradient-to-br from-sky-50 to-white overflow-hidden">
                                <CardContent className="p-6 lg:p-8">
                                    <div className="flex items-start gap-4">
                                        <div className="shrink-0 w-12 h-12 bg-sky-600 rounded-xl flex items-center justify-center">
                                            <Database className="w-6 h-6 text-white" />
                                        </div>
                                        <div>
                                            <h2 className="text-xl font-bold text-gray-900 mb-2">Dokumen Sistem Informasi</h2>
                                            <p className="text-gray-600 leading-relaxed">
                                                Dokumen terkait pemutakhiran data informasi kepegawaian unit kerja.
                                            </p>
                                        </div>
                                    </div>
                                </CardContent>
                            ...
                            <Card className="border-0 shadow-lg bg-gradient-to-br from-gray-50 to-white">
                                <CardContent className="p-6">
                                    <div className="flex items-start gap-4">
                                        ...
                                        <div>
                                            <h3 className="font-semibold text-gray-900 mb-1">Data Terpadu</h3>
                                            <p className="text-sm text-gray-600 leading-relaxed">
                                                Sistem informasi kepegawaian yang terintegrasi mendukung pengambilan keputusan berbasis data.
                                            </p>
                                        </div>
                                    </div>
                                </CardContent>
                ...
                <div className="container mx-auto px-4">
                    <div className="max-w-4xl mx-auto">
                        <div className="flex flex-col sm:flex-row items-center justify-between gap-4">
                            <Link href="/zi-wbk/manajemen-sdm/penetapan-kinerja"><Button variant="outline" className="gap-2"><ArrowLeft className="w-4 h-4" />Penetapan Kinerja</Button></Link>
                            <Link href="/zi-wbk/manajemen-sdm/penegakan-disiplin"><Button className="gap-2 bg-sky-600 hover:bg-sky-700">Penegakan Disiplin<ChevronRight className="w-4 h-4" /></Button></Link>
                        </div>
                    </div>
                </div>
            </section>
