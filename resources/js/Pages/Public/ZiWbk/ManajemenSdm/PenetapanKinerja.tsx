...
import { 
    ChevronRight, ArrowLeft, Target, FileText, FolderOpen, CheckCircle2, Shield, X, Loader2, ExternalLink, ChevronDown, FileCheck, BarChart3, Calendar, Award
} from 'lucide-react';
...
const documentIcons = [FileCheck, BarChart3, Calendar, Award];
                ...
                <div className="flex items-center justify-between px-6 py-4 border-b border-gray-100 bg-gradient-to-r from-slate-50 to-white">
                    <div className="flex items-center gap-3">
                        ...
                        <div>
                            ...
                            <p className="text-sm text-gray-500">Dokumen Penetapan Kinerja</p>
                        </div>
                    </div>
...
export default function PenetapanKinerja({ documents }: Props) {
    const [selectedDocument, setSelectedDocument] = useState<DocumentItem | null>(null);

    return (
        <PublicLayout title="Penetapan Kinerja Individu - ZI-WBK" description="Penetapan Kinerja Individu Pegawai">
                ...
                <div className="container relative mx-auto px-4">
                    <div className="max-w-4xl mx-auto">
                        <div className="flex items-center gap-2 text-rose-200 mb-6 text-sm flex-wrap">
                            ...
                            <ChevronRight className="h-4 w-4" />
                            <Link href="/zi-wbk/manajemen-sdm" className="hover:text-white transition-colors">Manajemen SDM</Link>
                            <ChevronRight className="h-4 w-4" />
                            <span className="text-white">Penetapan Kinerja</span>
                        </div>
                        <div className="flex items-start gap-6">
                            ...
                            <div>
                                <Badge className="mb-4 bg-yellow-400/90 text-gray-900 hover:bg-yellow-400 font-medium px-4 py-1.5">
                                    <Shield className="w-4 h-4 mr-2" />Manajemen SDM
                                </Badge>
                                <h1 className="text-3xl font-bold text-white sm:text-4xl lg:text-5xl mb-4">
                                    Penetapan Kinerja <span className="font-display italic text-yellow-400">Individu</span>
                                </h1>
                                <p className="text-lg text-rose-100/90 max-w-2xl leading-relaxed">
                                    Penetapan dan pengukuran kinerja individu pegawai secara periodik.
                                </p>
                            </div>
                        </div>
                    </div>
                            ...
                            <Card className="border-0 shadow-lg bg-gradient-to-br from-rose-50 to-white overflow-hidden">
                                <CardContent className="p-6 lg:p-8">
                                    <div className="flex items-start gap-4">
                                        ...
                                        <div>
                                            <h2 className="text-xl font-bold text-gray-900 mb-2">Dokumen Penetapan Kinerja</h2>
                                            <p className="text-gray-600 leading-relaxed">
                                                Dokumen terkait penetapan, pengukuran, dan penilaian kinerja individu pegawai.
                                            </p>
                                        </div>
                                    </div>
                                </CardContent>
                            ...
                            <Card className="border-0 shadow-lg bg-gradient-to-br from-gray-50 to-white">
                                <CardContent className="p-6">
                                    <div className="flex items-start gap-4">
                                        ...
                                        <div>
                                            <h3 className="font-semibold text-gray-900 mb-1">Manajemen Kinerja</h3>
                                            <p className="text-sm text-gray-600 leading-relaxed">
                                                Penetapan kinerja individu yang terukur mendorong peningkatan produktivitas dan pencapaian target organisasi.
                                            </p>
                                        </div>
                                    </div>
                                </CardContent>
                ...
                <div className="container mx-auto px-4">
                    <div className="max-w-4xl mx-auto">
                        <div className="flex flex-col sm:flex-row items-center justify-between gap-4">
                            <Link href="/zi-wbk/manajemen-sdm/pengembangan-pegawai"><Button variant="outline" className="gap-2"><ArrowLeft className="w-4 h-4" />Pengembangan Pegawai</Button></Link>
                            <Link href="/zi-wbk/manajemen-sdm/sistem-informasi"><Button className="gap-2 bg-rose-600 hover:bg-rose-700">Sistem Informasi<ChevronRight className="w-4 h-4" /></Button></Link>
                        </div>
                    </div>
                </div>
            </section>
