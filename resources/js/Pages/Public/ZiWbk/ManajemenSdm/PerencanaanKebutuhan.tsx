...
import { 
    ChevronRight, ArrowLeft, Users, FileText, FolderOpen, CheckCircle2, Shield, X, Loader2, ExternalLink, ChevronDown, ClipboardList, UserPlus, ClipboardCheck
} from 'lucide-react';
...
const documentIcons = [ClipboardList, UserPlus, ClipboardCheck];
                ...
                <div className="flex items-center justify-between px-6 py-4 border-b border-gray-100 bg-gradient-to-r from-slate-50 to-white">
                    <div className="flex items-center gap-3">
                        ...
                        <div>
                            ...
                            <p className="text-sm text-gray-500">Dokumen Perencanaan Kebutuhan</p>
                        </div>
                    </div>
...
const DocumentCard = ({ document, index, onViewDocuments }: { document: DocumentItem; index: number; onViewDocuments: (doc: DocumentItem) => void; }) => {
    ...
    const colorSchemes = [
        ...
        { bg: 'from-amber-500 to-amber-600', shadow: 'shadow-amber-500/25', light: 'bg-amber-50', text: 'text-amber-600' },
        { bg: 'from-yellow-500 to-yellow-600', shadow: 'shadow-yellow-500/25', light: 'bg-yellow-50', text: 'text-yellow-600' },
    ];
                ...
                <div className="p-6 cursor-pointer" onClick={() => setIsExpanded(!isExpanded)}>
                    <div className="flex items-start gap-4">
                        ...
                        <div className="flex-1 min-w-0">
                            ...
                            <h3 className="text-base lg:text-lg font-semibold text-gray-900 leading-relaxed group-hover:text-orange-600 transition-colors">{document.title}</h3>
...
export default function PerencanaanKebutuhan({ documents }: Props) {
    const [selectedDocument, setSelectedDocument] = useState<DocumentItem | null>(null);

    return (
        <PublicLayout title="Perencanaan Kebutuhan Pegawai - ZI-WBK" description="Perencanaan Kebutuhan Pegawai Sesuai Dengan Kebutuhan Organisasi">
            <section className="relative bg-gradient-to-br from-[#ea580c] via-[#c2410c] to-[#9a3412] py-16 lg:py-20 overflow-hidden">
                <div className="absolute inset-0 overflow-hidden">
                    <div className="absolute -top-24 -right-24 w-96 h-96 bg-yellow-400/10 rounded-full blur-3xl" />
                    <div className="absolute -bottom-32 -left-32 w-[500px] h-[500px] bg-orange-300/20 rounded-full blur-3xl" />
                </div>
                ...
                <div className="container relative mx-auto px-4">
                    <div className="max-w-4xl mx-auto">
                        <div className="flex items-center gap-2 text-orange-200 mb-6 text-sm flex-wrap">
                            ...
                            <ChevronRight className="h-4 w-4" />
                            <span className="text-white">Perencanaan Kebutuhan</span>
                        </div>
                        <div className="flex items-start gap-6">
                            ...
                            <div>
                                ...
                                <h1 className="text-3xl font-bold text-white sm:text-4xl lg:text-5xl mb-4">
                                    Perencanaan Kebutuhan <span className="font-display italic text-yellow-400">Pegawai</span>
                                </h1>
                                <p className="text-lg text-orange-100/90 max-w-2xl leading-relaxed">
            ...
            <section className="bg-gradient-to-b from-white to-gray-50 py-12 lg:py-16">
                <div className="container mx-auto px-4">
                    <div className="max-w-4xl mx-auto">
                        <div className="mb-10">
                            <Card className="border-0 shadow-lg bg-gradient-to-br from-orange-50 to-white overflow-hidden">
                                <CardContent className="p-6 lg:p-8">
                                    <div className="flex items-start gap-4">
                                        <div className="shrink-0 w-12 h-12 bg-orange-600 rounded-xl flex items-center justify-center">
                                            <Users className="w-6 h-6 text-white" />
                                        </div>
                                        <div>
                                            <h2 className="text-xl font-bold text-gray-900 mb-2">Dokumen Perencanaan Kebutuhan</h2>
                                            <p className="text-gray-600 leading-relaxed">
                                                Dokumen terkait perencanaan kebutuhan pegawai berdasarkan peta jabatan dan analisis beban kerja.
                                            </p>
                                        </div>
                                    </div>
                                </CardContent>
                            ...
                            <Card className="border-0 shadow-lg bg-gradient-to-br from-gray-50 to-white">
                                <CardContent className="p-6">
                                    <div className="flex items-start gap-4">
                                        ...
                                        <div>
                                            <h3 className="font-semibold text-gray-900 mb-1">Perencanaan SDM</h3>
                                            <p className="text-sm text-gray-600 leading-relaxed">
                                                Perencanaan kebutuhan pegawai yang tepat memastikan organisasi memiliki SDM yang kompeten sesuai kebutuhan.
                                            </p>
                                        </div>
                                    </div>
                                </CardContent>
                ...
                <div className="container mx-auto px-4">
                    <div className="max-w-4xl mx-auto">
                        <div className="flex flex-col sm:flex-row items-center justify-between gap-4">
                            ...
                            <Link href="/zi-wbk/manajemen-sdm/pola-mutasi"><Button className="gap-2 bg-orange-600 hover:bg-orange-700">Pola Mutasi<ChevronRight className="w-4 h-4" /></Button></Link>
                        </div>
                    </div>
                </div>
            </section>
