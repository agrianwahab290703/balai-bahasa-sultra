...
import { 
    ChevronRight, ArrowLeft, Repeat, FileText, FolderOpen, CheckCircle2, Shield, X, Loader2, ExternalLink, ChevronDown, ArrowRightLeft, Target, ClipboardCheck
} from 'lucide-react';
...
const documentIcons = [ArrowRightLeft, Target, ClipboardCheck];
                ...
                <div className="flex items-center justify-between px-6 py-4 border-b border-gray-100 bg-gradient-to-r from-slate-50 to-white">
                    <div className="flex items-center gap-3">
                        ...
                        <div>
                            ...
                            <p className="text-sm text-gray-500">Dokumen Pola Mutasi</p>
                        </div>
                    </div>
...
export default function PolaMutasi({ documents }: Props) {
    const [selectedDocument, setSelectedDocument] = useState<DocumentItem | null>(null);

    return (
        <PublicLayout title="Pola Mutasi Internal - ZI-WBK" description="Pola Mutasi Internal Pegawai">
                ...
                <div className="container relative mx-auto px-4">
                    <div className="max-w-4xl mx-auto">
                        <div className="flex items-center gap-2 text-teal-200 mb-6 text-sm flex-wrap">
                            ...
                            <ChevronRight className="h-4 w-4" />
                            <span className="text-white">Pola Mutasi</span>
                        </div>
                        <div className="flex items-start gap-6">
                            <div className="hidden sm:flex shrink-0 w-16 h-16 bg-white/10 backdrop-blur-sm rounded-2xl items-center justify-center">
                                <Repeat className="w-8 h-8 text-yellow-400" />
                            </div>
                            <div>
                                ...
                                <h1 className="text-3xl font-bold text-white sm:text-4xl lg:text-5xl mb-4">
                                    Pola Mutasi <span className="font-display italic text-yellow-400">Internal</span>
                                </h1>
                                <p className="text-lg text-teal-100/90 max-w-2xl leading-relaxed">
                                    Pengembangan karier pegawai melalui mutasi antar jabatan.
                                </p>
                            </div>
                        </div>
                    </div>
                            ...
                            <Card className="border-0 shadow-lg bg-gradient-to-br from-teal-50 to-white overflow-hidden">
                                <CardContent className="p-6 lg:p-8">
                                    <div className="flex items-start gap-4">
                                        ...
                                        <div>
                                            <h2 className="text-xl font-bold text-gray-900 mb-2">Dokumen Pola Mutasi</h2>
                                            <p className="text-gray-600 leading-relaxed">
                                                Dokumen terkait pola mutasi internal pegawai untuk pengembangan karier.
                                            </p>
                                        </div>
                                    </div>
                                </CardContent>
                            ...
                            <Card className="border-0 shadow-lg bg-gradient-to-br from-gray-50 to-white">
                                <CardContent className="p-6">
                                    <div className="flex items-start gap-4">
                                        ...
                                        <div>
                                            <h3 className="font-semibold text-gray-900 mb-1">Pengembangan Karier</h3>
                                            <p className="text-sm text-gray-600 leading-relaxed">
                                                Mutasi internal yang terencana mendukung pengembangan karier dan peningkatan kinerja pegawai.
                                            </p>
                                        </div>
                                    </div>
                                </CardContent>
                ...
                <div className="container mx-auto px-4">
                    <div className="max-w-4xl mx-auto">
                        <div className="flex flex-col sm:flex-row items-center justify-between gap-4">
                            <Link href="/zi-wbk/manajemen-sdm/perencanaan-kebutuhan"><Button variant="outline" className="gap-2"><ArrowLeft className="w-4 h-4" />Perencanaan Kebutuhan</Button></Link>
                            <Link href="/zi-wbk/manajemen-sdm/pengembangan-pegawai"><Button className="gap-2 bg-teal-600 hover:bg-teal-700">Pengembangan Pegawai<ChevronRight className="w-4 h-4" /></Button></Link>
                        </div>
                    </div>
                </div>
            </section>
