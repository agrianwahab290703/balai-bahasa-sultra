...
import { 
    ChevronRight, ArrowLeft, Bell, FileText, FolderOpen, CheckCircle2, Shield, X, Loader2, ExternalLink, ChevronDown, CheckSquare, ClipboardCheck, Send
} from 'lucide-react';
...
const documentIcons = [CheckSquare, ClipboardCheck, Send];
                ...
                <div className="flex items-center justify-between px-6 py-4 border-b border-gray-100 bg-gradient-to-r from-slate-50 to-white">
                    <div className="flex items-center gap-3">
                        ...
                        <div>
                            ...
                            <p className="text-sm text-gray-500">Dokumen WBS</p>
                        </div>
                    </div>
...
export default function WhistleBlowing({ documents }: Props) {
    const [selectedDocument, setSelectedDocument] = useState<DocumentItem | null>(null);

    return (
        <PublicLayout title="Whistle-Blowing System - ZI-WBK" description="Whistle-Blowing System dalam Penguatan Pengawasan">
                        ...
                        <div className="flex items-start gap-6">
                            ...
                            <div>
                                ...
                                <h1 className="text-3xl font-bold text-white sm:text-4xl lg:text-5xl mb-4">
                                    Whistle-Blowing <span className="font-display italic text-yellow-400">System</span>
                                </h1>
                                <p className="text-lg text-orange-100/90 max-w-2xl leading-relaxed">
                                    Sistem pelaporan pelanggaran untuk mendorong transparansi dan akuntabilitas.
                                </p>
                            </div>
                        </div>
                    </div>
                            ...
                            <Card className="border-0 shadow-lg bg-gradient-to-br from-orange-50 to-white overflow-hidden">
                                <CardContent className="p-6 lg:p-8">
                                    <div className="flex items-start gap-4">
                                        ...
                                        <div>
                                            <h2 className="text-xl font-bold text-gray-900 mb-2">Dokumen WBS</h2>
                                            <p className="text-gray-600 leading-relaxed">
                                                Dokumen terkait penerapan dan evaluasi Whistle-Blowing System.
                                            </p>
                                        </div>
                                    </div>
                                </CardContent>
                            ...
                            <Card className="border-0 shadow-lg bg-gradient-to-br from-gray-50 to-white">
                                <CardContent className="p-6">
                                    <div className="flex items-start gap-4">
                                        ...
                                        <div>
                                            <h3 className="font-semibold text-gray-900 mb-1">Transparansi</h3>
                                            <p className="text-sm text-gray-600 leading-relaxed">
                                                Whistle-Blowing System mendorong terciptanya budaya transparansi dan anti-korupsi di lingkungan kerja.
                                            </p>
                                        </div>
                                    </div>
                                </CardContent>
                ...
                <div className="container mx-auto px-4">
                    <div className="max-w-4xl mx-auto">
                        <div className="flex flex-col sm:flex-row items-center justify-between gap-4">
                            <Link href="/zi-wbk/penguatan-pengawasan/pengaduan-masyarakat"><Button variant="outline" className="gap-2"><ArrowLeft className="w-4 h-4" />Pengaduan Masyarakat</Button></Link>
                            <Link href="/zi-wbk/penguatan-pengawasan/penanganan-benturan"><Button className="gap-2 bg-orange-600 hover:bg-orange-700">Penanganan Benturan<ChevronRight className="w-4 h-4" /></Button></Link>
                        </div>
                    </div>
                </div>
            </section>
