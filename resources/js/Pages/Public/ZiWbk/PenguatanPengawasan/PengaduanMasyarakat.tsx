...
import { 
    ChevronRight, ArrowLeft, MessageSquare, FileText, FolderOpen, CheckCircle2, Shield, X, Loader2, ExternalLink, ChevronDown, FileCheck, Send, ClipboardCheck, CheckSquare
} from 'lucide-react';
...
const documentIcons = [FileCheck, Send, ClipboardCheck, CheckSquare];
                ...
                <div className="flex items-center justify-between px-6 py-4 border-b border-gray-100 bg-gradient-to-r from-slate-50 to-white">
                    <div className="flex items-center gap-3">
                        ...
                        <div>
                            ...
                            <p className="text-sm text-gray-500">Dokumen Pengaduan Masyarakat</p>
                        </div>
                    </div>
                ...
                <div className="p-6 cursor-pointer" onClick={() => setIsExpanded(!isExpanded)}>
                    <div className="flex items-start gap-4">
                        ...
                        <div className="flex-1 min-w-0">
                            ...
                            <h3 className="text-base lg:text-lg font-semibold text-gray-900 leading-relaxed group-hover:text-green-600 transition-colors">{document.title}</h3>
...
export default function PengaduanMasyarakat({ documents }: Props) {
    const [selectedDocument, setSelectedDocument] = useState<DocumentItem | null>(null);

    return (
        <PublicLayout title="Pengaduan Masyarakat - ZI-WBK" description="Pengaduan Masyarakat dalam Penguatan Pengawasan">
            <section className="relative bg-gradient-to-br from-[#16a34a] via-[#15803d] to-[#166534] py-16 lg:py-20 overflow-hidden">
                <div className="absolute inset-0 overflow-hidden">
                    <div className="absolute -top-24 -right-24 w-96 h-96 bg-yellow-400/10 rounded-full blur-3xl" />
                    <div className="absolute -bottom-32 -left-32 w-[500px] h-[500px] bg-green-300/20 rounded-full blur-3xl" />
                </div>
                ...
                <div className="container relative mx-auto px-4">
                    <div className="max-w-4xl mx-auto">
                        <div className="flex items-center gap-2 text-green-200 mb-6 text-sm flex-wrap">
                            ...
                            <ChevronRight className="h-4 w-4" />
                            <span className="text-white">Pengaduan Masyarakat</span>
                        </div>
                        <div className="flex items-start gap-6">
                            ...
                            <div>
                                ...
                                <h1 className="text-3xl font-bold text-white sm:text-4xl lg:text-5xl mb-4">
                                    Pengaduan <span className="font-display italic text-yellow-400">Masyarakat</span>
                                </h1>
                                <p className="text-lg text-green-100/90 max-w-2xl leading-relaxed">
                                    Penanganan pengaduan masyarakat yang responsif dan akuntabel.
                                </p>
                            </div>
                        </div>
                    </div>
            ...
            <section className="bg-gradient-to-b from-white to-gray-50 py-12 lg:py-16">
                <div className="container mx-auto px-4">
                    <div className="max-w-4xl mx-auto">
                        <div className="mb-10">
                            <Card className="border-0 shadow-lg bg-gradient-to-br from-green-50 to-white overflow-hidden">
                                <CardContent className="p-6 lg:p-8">
                                    <div className="flex items-start gap-4">
                                        <div className="shrink-0 w-12 h-12 bg-green-600 rounded-xl flex items-center justify-center">
                                            <MessageSquare className="w-6 h-6 text-white" />
                                        </div>
                                        <div>
                                            <h2 className="text-xl font-bold text-gray-900 mb-2">Dokumen Pengaduan Masyarakat</h2>
                                            <p className="text-gray-600 leading-relaxed">
                                                Dokumen terkait penanganan pengaduan masyarakat.
                                            </p>
                                        </div>
                                    </div>
                                </CardContent>
                            ...
                            <Card className="border-0 shadow-lg bg-gradient-to-br from-gray-50 to-white">
                                <CardContent className="p-6">
                                    <div className="flex items-start gap-4">
                                        ...
                                        <div>
                                            <h3 className="font-semibold text-gray-900 mb-1">Layanan Responsif</h3>
                                            <p className="text-sm text-gray-600 leading-relaxed">
                                                Penanganan pengaduan masyarakat yang cepat dan tepat meningkatkan kepercayaan publik.
                                            </p>
                                        </div>
                                    </div>
                                </CardContent>
                ...
                <div className="container mx-auto px-4">
                    <div className="max-w-4xl mx-auto">
                        <div className="flex flex-col sm:flex-row items-center justify-between gap-4">
                            <Link href="/zi-wbk/penguatan-pengawasan/penerapan-spip"><Button variant="outline" className="gap-2"><ArrowLeft className="w-4 h-4" />Penerapan SPIP</Button></Link>
                            <Link href="/zi-wbk/penguatan-pengawasan/whistle-blowing"><Button className="gap-2 bg-green-600 hover:bg-green-700">Whistle-Blowing<ChevronRight className="w-4 h-4" /></Button></Link>
                        </div>
                    </div>
                </div>
            </section>
