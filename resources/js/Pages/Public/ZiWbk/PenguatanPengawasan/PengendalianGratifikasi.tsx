...
import { 
    ChevronRight, ArrowLeft, Gift, FileText, FolderOpen, CheckCircle2, Shield, X, Loader2, ExternalLink, ChevronDown, Megaphone, Ban, Phone, AlertCircle
} from 'lucide-react';
...
const documentIcons = [Megaphone, Ban];
                ...
                <div className="flex items-center justify-between px-6 py-4 border-b border-gray-100 bg-gradient-to-r from-slate-50 to-white">
                    <div className="flex items-center gap-3">
                        ...
                        <div>
                            ...
                            <p className="text-sm text-gray-500">Dokumen Pengendalian Gratifikasi</p>
                        </div>
                    </div>
...
const DocumentCard = ({ document, index, onViewDocuments }: { document: DocumentItem; index: number; onViewDocuments: (doc: DocumentItem) => void; }) => {
    ...
    const colorSchemes = [
        { bg: 'from-red-500 to-red-600', shadow: 'shadow-red-500/25', light: 'bg-red-50', text: 'text-red-600' },
                ...
                <div className="p-6 cursor-pointer" onClick={() => setIsExpanded(!isExpanded)}>
                    <div className="flex items-start gap-4">
                        ...
                        <div className="flex-1 min-w-0">
                            ...
                            <h3 className="text-base lg:text-lg font-semibold text-gray-900 leading-relaxed group-hover:text-red-600 transition-colors">{document.title}</h3>
...
export default function PengendalianGratifikasi({ documents }: Props) {
    const [selectedDocument, setSelectedDocument] = useState<DocumentItem | null>(null);

    return (
        <PublicLayout title="Pengendalian Gratifikasi - ZI-WBK" description="Pengendalian Gratifikasi dalam Penguatan Pengawasan">
            <section className="relative bg-gradient-to-br from-[#dc2626] via-[#b91c1c] to-[#991b1b] py-16 lg:py-20 overflow-hidden">
                <div className="absolute inset-0 overflow-hidden">
                    <div className="absolute -top-24 -right-24 w-96 h-96 bg-yellow-400/10 rounded-full blur-3xl" />
                    <div className="absolute -bottom-32 -left-32 w-[500px] h-[500px] bg-red-300/20 rounded-full blur-3xl" />
                </div>
                ...
                <div className="container relative mx-auto px-4">
                    <div className="max-w-4xl mx-auto">
                        <div className="flex items-center gap-2 text-red-200 mb-6 text-sm flex-wrap">
                            <Link href="/" className="hover:text-white transition-colors">Beranda</Link>
                            <ChevronRight className="h-4 w-4" />
                            <Link href="/zi-wbk" className="hover:text-white transition-colors">ZI-WBK</Link>
                            <ChevronRight className="h-4 w-4" />
                            <Link href="/zi-wbk/penguatan-pengawasan" className="hover:text-white transition-colors">Penguatan Pengawasan</Link>
                            <ChevronRight className="h-4 w-4" />
                            <span className="text-white">Pengendalian Gratifikasi</span>
                        </div>
                        <div className="flex items-start gap-6">
                            ...
                            <div>
                                <Badge className="mb-4 bg-yellow-400/90 text-gray-900 hover:bg-yellow-400 font-medium px-4 py-1.5">
                                    <Shield className="w-4 h-4 mr-2" />Penguatan Pengawasan
                                </Badge>
                                <h1 className="text-3xl font-bold text-white sm:text-4xl lg:text-5xl mb-4">
                                    Pengendalian <span className="font-display italic text-yellow-400">Gratifikasi</span>
                                </h1>
                                <p className="text-lg text-red-100/90 max-w-2xl leading-relaxed">
                                    Upaya pengendalian gratifikasi melalui public campaign dan implementasi kebijakan.
                                </p>
                            </div>
                        </div>
                    </div>
            ...
            <section className="bg-gradient-to-b from-white to-gray-50 py-12 lg:py-16">
                <div className="container mx-auto px-4">
                    <div className="max-w-4xl mx-auto">
                        ...
                        <div className="mb-8">
                            <Card className="border-2 border-amber-200 shadow-lg bg-gradient-to-br from-amber-50 to-yellow-50 overflow-hidden">
                                <CardContent className="p-6 lg:p-8">
                                    <div className="flex items-start gap-4">
                                        <div className="shrink-0 w-12 h-12 bg-amber-500 rounded-xl flex items-center justify-center">
                                            <AlertCircle className="w-6 h-6 text-white" />
                                        </div>
                                        <div>
                                            <h2 className="text-lg font-bold text-amber-800 mb-3">Pemberitahuan Penting</h2>
                                            <p className="text-amber-900 font-medium leading-relaxed mb-4">
                                                Seluruh pelayanan yang di KBST tidak dipungut biaya, kecuali layanan UKBI.
                                            </p>
                                            <div className="flex items-center gap-2 text-amber-800">
                                                <Phone className="w-5 h-5" />
                                                <span className="font-medium">Untuk informasi lebih lanjut tentang pelayanan di KBST, Anda dapat menghubungi </span>
                                                <a href="https://wa.me/6281342520567" target="_blank" rel="noopener noreferrer" className="font-bold text-green-700 hover:underline">081342520567</a>
                                            </div>
                                        </div>
                                    </div>
                                </CardContent>
                        ...
                        <div className="mb-10">
                            <Card className="border-0 shadow-lg bg-gradient-to-br from-red-50 to-white overflow-hidden">
                                <CardContent className="p-6 lg:p-8">
                                    <div className="flex items-start gap-4">
                                        ...
                                        <div>
                                            <h2 className="text-xl font-bold text-gray-900 mb-2">Dokumen Pengendalian Gratifikasi</h2>
                                            <p className="text-gray-600 leading-relaxed">
                                                Dokumen terkait public campaign dan implementasi pengendalian gratifikasi.
                                            </p>
                                        </div>
                                    </div>
                                </CardContent>
                            ...
                            <Card className="border-0 shadow-lg bg-gradient-to-br from-gray-50 to-white">
                                <CardContent className="p-6">
                                    <div className="flex items-start gap-4">
                                        ...
                                        <div>
                                            <h3 className="font-semibold text-gray-900 mb-1">Anti Gratifikasi</h3>
                                            <p className="text-sm text-gray-600 leading-relaxed">
                                                Pengendalian gratifikasi merupakan upaya penting dalam mewujudkan tata kelola pemerintahan yang bersih dan bebas korupsi.
                                            </p>
                                        </div>
                                    </div>
                                </CardContent>
                ...
                <div className="container mx-auto px-4">
                    <div className="max-w-4xl mx-auto">
                        <div className="flex flex-col sm:flex-row items-center justify-between gap-4">
                            <Link href="/zi-wbk"><Button variant="outline" className="gap-2"><ArrowLeft className="w-4 h-4" />ZI-WBK</Button></Link>
                            <Link href="/zi-wbk/penguatan-pengawasan/penerapan-spip"><Button className="gap-2 bg-red-600 hover:bg-red-700">Penerapan SPIP<ChevronRight className="w-4 h-4" /></Button></Link>
                        </div>
                    </div>
                </div>
            </section>
