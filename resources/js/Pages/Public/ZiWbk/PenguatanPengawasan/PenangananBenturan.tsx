...
import { 
    ChevronRight, ArrowLeft, Scale, FileText, FolderOpen, CheckCircle2, Shield, X, Loader2, ExternalLink, ChevronDown, Search, Megaphone, CheckSquare, ClipboardCheck, Send
} from 'lucide-react';
...
const documentIcons = [Search, Megaphone, CheckSquare, ClipboardCheck, Send];
                ...
                <div className="flex items-center justify-between px-6 py-4 border-b border-gray-100 bg-gradient-to-r from-slate-50 to-white">
                    <div className="flex items-center gap-3">
                        ...
                        <div>
                            ...
                            <p className="text-sm text-gray-500">Dokumen Benturan Kepentingan</p>
                        </div>
                    </div>
                ...
                <div className="p-6 cursor-pointer" onClick={() => setIsExpanded(!isExpanded)}>
                    <div className="flex items-start gap-4">
                        ...
                        <div className="flex-1 min-w-0">
                            ...
                            <h3 className="text-base lg:text-lg font-semibold text-gray-900 leading-relaxed group-hover:text-purple-600 transition-colors">{document.title}</h3>
...
export default function PenangananBenturan({ documents }: Props) {
    const [selectedDocument, setSelectedDocument] = useState<DocumentItem | null>(null);

    return (
        <PublicLayout title="Penanganan Benturan Kepentingan - ZI-WBK" description="Penanganan Benturan Kepentingan dalam Penguatan Pengawasan">
            <section className="relative bg-gradient-to-br from-[#9333ea] via-[#7c3aed] to-[#6d28d9] py-16 lg:py-20 overflow-hidden">
                <div className="absolute inset-0 overflow-hidden">
                    <div className="absolute -top-24 -right-24 w-96 h-96 bg-yellow-400/10 rounded-full blur-3xl" />
                    <div className="absolute -bottom-32 -left-32 w-[500px] h-[500px] bg-purple-300/20 rounded-full blur-3xl" />
                </div>
                ...
                <div className="container relative mx-auto px-4">
                    <div className="max-w-4xl mx-auto">
                        <div className="flex items-center gap-2 text-purple-200 mb-6 text-sm flex-wrap">
                            ...
                            <ChevronRight className="h-4 w-4" />
                            <span className="text-white">Penanganan Benturan</span>
                        </div>
                        <div className="flex items-start gap-6">
                            ...
                            <div>
                                ...
                                <h1 className="text-3xl font-bold text-white sm:text-4xl lg:text-5xl mb-4">
                                    Penanganan Benturan <span className="font-display italic text-yellow-400">Kepentingan</span>
                                </h1>
                                <p className="text-lg text-purple-100/90 max-w-2xl leading-relaxed">
                                    Identifikasi, sosialisasi, dan penanganan benturan kepentingan.
                                </p>
                            </div>
                        </div>
                    </div>
                            ...
                            <Card className="border-0 shadow-lg bg-gradient-to-br from-purple-50 to-white overflow-hidden">
                                <CardContent className="p-6 lg:p-8">
                                    <div className="flex items-start gap-4">
                                        ...
                                        <div>
                                            <h2 className="text-xl font-bold text-gray-900 mb-2">Dokumen Benturan Kepentingan</h2>
                                            <p className="text-gray-600 leading-relaxed">
                                                Dokumen terkait penanganan benturan kepentingan.
                                            </p>
                                        </div>
                                    </div>
                                </CardContent>
                            ...
                            <Card className="border-0 shadow-lg bg-gradient-to-br from-gray-50 to-white">
                                <CardContent className="p-6">
                                    <div className="flex items-start gap-4">
                                        ...
                                        <div>
                                            <h3 className="font-semibold text-gray-900 mb-1">Integritas</h3>
                                            <p className="text-sm text-gray-600 leading-relaxed">
                                                Penanganan benturan kepentingan yang tepat menjaga integritas dan objektivitas dalam pengambilan keputusan.
                                            </p>
                                        </div>
                                    </div>
                                </CardContent>
                ...
                <div className="container mx-auto px-4">
                    <div className="max-w-4xl mx-auto">
                        <div className="flex flex-col sm:flex-row items-center justify-between gap-4">
                            <Link href="/zi-wbk/penguatan-pengawasan/whistle-blowing"><Button variant="outline" className="gap-2"><ArrowLeft className="w-4 h-4" />Whistle-Blowing</Button></Link>
                            <Link href="/zi-wbk"><Button className="gap-2 bg-purple-600 hover:bg-purple-700">Kembali ke ZI-WBK<ChevronRight className="w-4 h-4" /></Button></Link>
                        </div>
                    </div>
                </div>
            </section>
