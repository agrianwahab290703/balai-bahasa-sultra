...
import { 
    ChevronRight, ArrowLeft, MessageCircle, FileText, FolderOpen, CheckCircle2, Star, X, Loader2, ExternalLink, ChevronDown, Send, Users, ClipboardCheck
} from 'lucide-react';
...
const documentIcons = [Send, Users, ClipboardCheck];
                ...
                <div className="flex items-center justify-between px-6 py-4 border-b border-gray-100 bg-gradient-to-r from-slate-50 to-white">
                    <div className="flex items-center gap-3">
                        ...
                        <div>
                            ...
                            <p className="text-sm text-gray-500">Dokumen Pengelolaan Pengaduan</p>
                        </div>
                    </div>
...
export default function PengelolaanPengaduan({ documents }: Props) {
    const [selectedDocument, setSelectedDocument] = useState<DocumentItem | null>(null);

    return (
        <PublicLayout title="Pengelolaan Pengaduan - ZI-WBK" description="Pengelolaan Pengaduan dalam Penguatan Kualitas Pelayanan Publik">
                ...
                <div className="container relative mx-auto px-4">
                    <div className="max-w-4xl mx-auto">
                        <div className="flex items-center gap-2 text-orange-200 mb-6 text-sm flex-wrap">
                            ...
                            <ChevronRight className="h-4 w-4" />
                            <span className="text-white">Pengelolaan Pengaduan</span>
                        </div>
                        <div className="flex items-start gap-6">
                            ...
                            <div>
                                ...
                                <h1 className="text-3xl font-bold text-white sm:text-4xl lg:text-5xl mb-4">
                                    Pengelolaan <span className="font-display italic text-yellow-400">Pengaduan</span>
                                </h1>
                                <p className="text-lg text-orange-100/90 max-w-2xl leading-relaxed">
                                    Sistem pengelolaan pengaduan masyarakat yang terintegrasi dan responsif.
                                </p>
                            </div>
                        </div>
                    </div>
                            ...
                            <Card className="border-0 shadow-lg bg-gradient-to-br from-orange-50 to-white overflow-hidden">
                                <CardContent className="p-6 lg:p-8">
                                    <div className="flex items-start gap-4">
                                        ...
                                        <div>
                                            <h2 className="text-xl font-bold text-gray-900 mb-2">Dokumen Pengelolaan Pengaduan</h2>
                                            <p className="text-gray-600 leading-relaxed">
                                                Dokumen terkait sistem pengelolaan pengaduan masyarakat.
                                            </p>
                                        </div>
                                    </div>
                                </CardContent>
                            ...
                            <Card className="border-0 shadow-lg bg-gradient-to-br from-gray-50 to-white">
                                <CardContent className="p-6">
                                    <div className="flex items-start gap-4">
                                        ...
                                        <div>
                                            <h3 className="font-semibold text-gray-900 mb-1">Responsif dan Akuntabel</h3>
                                            <p className="text-sm text-gray-600 leading-relaxed">
                                                Pengelolaan pengaduan yang baik meningkatkan kepercayaan dan kepuasan masyarakat.
                                            </p>
                                        </div>
                                    </div>
                                </CardContent>
                ...
                <div className="container mx-auto px-4">
                    <div className="max-w-4xl mx-auto">
                        <div className="flex flex-col sm:flex-row items-center justify-between gap-4">
                            <Link href="/zi-wbk/penguatan-kualitas-pelayanan-publik/pemanfaatan-teknologi"><Button variant="outline" className="gap-2"><ArrowLeft className="w-4 h-4" />Pemanfaatan Teknologi</Button></Link>
                            <Link href="/zi-wbk/penguatan-kualitas-pelayanan-publik/penilaian-kepuasan"><Button className="gap-2 bg-orange-600 hover:bg-orange-700">Penilaian Kepuasan<ChevronRight className="w-4 h-4" /></Button></Link>
                        </div>
                    </div>
                </div>
            </section>
