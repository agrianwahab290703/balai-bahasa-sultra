...
import { 
    ChevronRight, ArrowLeft, Award, FileText, FolderOpen, CheckCircle2, Star, X, Loader2, ExternalLink, ChevronDown, Users, Megaphone, Trophy, Gift, Building2, Lightbulb
} from 'lucide-react';
...
const documentIcons = [Users, Megaphone, Trophy, Gift, Building2, Lightbulb];
                ...
                <div className="flex items-center justify-between px-6 py-4 border-b border-gray-100 bg-gradient-to-r from-slate-50 to-white">
                    <div className="flex items-center gap-3">
                        ...
                        <div>
                            ...
                            <p className="text-sm text-gray-500">Dokumen Budaya Pelayanan Prima</p>
                        </div>
                    </div>
                ...
                <div className="p-6 cursor-pointer" onClick={() => setIsExpanded(!isExpanded)}>
                    <div className="flex items-start gap-4">
                        ...
                        <div className="flex-1 min-w-0">
                            ...
                            <h3 className="text-base lg:text-lg font-semibold text-gray-900 leading-relaxed group-hover:text-rose-600 transition-colors">{document.title}</h3>
...
export default function BudayaPelayanan({ documents }: Props) {
    const [selectedDocument, setSelectedDocument] = useState<DocumentItem | null>(null);

    return (
        <PublicLayout title="Budaya Pelayanan Prima - ZI-WBK" description="Budaya Pelayanan Prima dalam Penguatan Kualitas Pelayanan Publik">
            <section className="relative bg-gradient-to-br from-[#e11d48] via-[#be123c] to-[#9f1239] py-16 lg:py-20 overflow-hidden">
                ...
                <div className="container relative mx-auto px-4">
                    <div className="max-w-4xl mx-auto">
                        <div className="flex items-center gap-2 text-rose-200 mb-6 text-sm flex-wrap">
                            ...
                            <ChevronRight className="h-4 w-4" />
                            <span className="text-white">Budaya Pelayanan Prima</span>
                        </div>
                        <div className="flex items-start gap-6">
                            ...
                            <div>
                                ...
                                <h1 className="text-3xl font-bold text-white sm:text-4xl lg:text-5xl mb-4">
                                    Budaya Pelayanan <span className="font-display italic text-yellow-400">Prima</span>
                                </h1>
                                <p className="text-lg text-rose-100/90 max-w-2xl leading-relaxed">
                                    Upaya peningkatan kualitas pelayanan melalui budaya pelayanan prima.
                                </p>
                            </div>
                        </div>
                    </div>
                            ...
                            <Card className="border-0 shadow-lg bg-gradient-to-br from-rose-50 to-white overflow-hidden">
                                <CardContent className="p-6 lg:p-8">
                                    <div className="flex items-start gap-4">
                                        ...
                                        <div>
                                            <h2 className="text-xl font-bold text-gray-900 mb-2">Dokumen Budaya Pelayanan Prima</h2>
                                            <p className="text-gray-600 leading-relaxed">
                                                Dokumen terkait upaya peningkatan kualitas pelayanan prima.
                                            </p>
                                        </div>
                                    </div>
                                </CardContent>
                            ...
                            <Card className="border-0 shadow-lg bg-gradient-to-br from-gray-50 to-white">
                                <CardContent className="p-6">
                                    <div className="flex items-start gap-4">
                                        ...
                                        <div>
                                            <h3 className="font-semibold text-gray-900 mb-1">Pelayanan Berkualitas</h3>
                                            <p className="text-sm text-gray-600 leading-relaxed">
                                                Budaya pelayanan prima menciptakan kepuasan masyarakat dan kepercayaan publik.
                                            </p>
                                        </div>
                                    </div>
                                </CardContent>
                ...
                <div className="container mx-auto px-4">
                    <div className="max-w-4xl mx-auto">
                        <div className="flex flex-col sm:flex-row items-center justify-between gap-4">
                            <Link href="/zi-wbk/penguatan-kualitas-pelayanan-publik"><Button variant="outline" className="gap-2"><ArrowLeft className="w-4 h-4" />Penguatan Kualitas</Button></Link>
                            <Link href="/zi-wbk/penguatan-kualitas-pelayanan-publik/pemanfaatan-teknologi"><Button className="gap-2 bg-rose-600 hover:bg-rose-700">Pemanfaatan Teknologi<ChevronRight className="w-4 h-4" /></Button></Link>
                        </div>
                    </div>
                </div>
            </section>
