...
import { 
    ChevronRight, ArrowLeft, Monitor, FileText, FolderOpen, CheckCircle2, Star, X, Loader2, ExternalLink, ChevronDown, Laptop, RefreshCw, Database
} from 'lucide-react';
...
const documentIcons = [Laptop, RefreshCw, Database];
                ...
                <div className="flex items-center justify-between px-6 py-4 border-b border-gray-100 bg-gradient-to-r from-slate-50 to-white">
                    <div className="flex items-center gap-3">
                        ...
                        <div>
                            ...
                            <p className="text-sm text-gray-500">Dokumen Pemanfaatan Teknologi</p>
                        </div>
                    </div>
...
export default function PemanfaatanTeknologi({ documents }: Props) {
    const [selectedDocument, setSelectedDocument] = useState<DocumentItem | null>(null);

    return (
        <PublicLayout title="Pemanfaatan Teknologi - ZI-WBK" description="Pemanfaatan Teknologi dalam Penguatan Kualitas Pelayanan Publik">
                ...
                <div className="container relative mx-auto px-4">
                    <div className="max-w-4xl mx-auto">
                        <div className="flex items-center gap-2 text-blue-200 mb-6 text-sm flex-wrap">
                            ...
                            <ChevronRight className="h-4 w-4" />
                            <span className="text-white">Pemanfaatan Teknologi</span>
                        </div>
                        <div className="flex items-start gap-6">
                            ...
                            <div>
                                ...
                                <h1 className="text-3xl font-bold text-white sm:text-4xl lg:text-5xl mb-4">
                                    Pemanfaatan <span className="font-display italic text-cyan-400">Teknologi</span>
                                </h1>
                                <p className="text-lg text-blue-100/90 max-w-2xl leading-relaxed">
                                    Penerapan teknologi informasi dalam meningkatkan kualitas pelayanan.
                                </p>
                            </div>
                        </div>
                    </div>
                            ...
                            <Card className="border-0 shadow-lg bg-gradient-to-br from-blue-50 to-white overflow-hidden">
                                <CardContent className="p-6 lg:p-8">
                                    <div className="flex items-start gap-4">
                                        ...
                                        <div>
                                            <h2 className="text-xl font-bold text-gray-900 mb-2">Dokumen Pemanfaatan Teknologi</h2>
                                            <p className="text-gray-600 leading-relaxed">
                                                Dokumen terkait penerapan teknologi informasi dalam pelayanan.
                                            </p>
                                        </div>
                                    </div>
                                </CardContent>
                                    ...
                                    <div className="flex items-start gap-4">
                                        ...
                                        <div>
                                            ...
                                            <p className="text-sm text-gray-600 leading-relaxed">
                                                Pemanfaatan teknologi informasi mempercepat dan memudahkan pelayanan kepada masyarakat.
                                            </p>
                                        </div>
                                    </div>
                                </CardContent>
                ...
                <div className="container mx-auto px-4">
                    <div className="max-w-4xl mx-auto">
                        <div className="flex flex-col sm:flex-row items-center justify-between gap-4">
                            <Link href="/zi-wbk/penguatan-kualitas-pelayanan-publik/budaya-pelayanan"><Button variant="outline" className="gap-2"><ArrowLeft className="w-4 h-4" />Budaya Pelayanan</Button></Link>
                            <Link href="/zi-wbk/penguatan-kualitas-pelayanan-publik/pengelolaan-pengaduan"><Button className="gap-2 bg-blue-600 hover:bg-blue-700">Pengelolaan Pengaduan<ChevronRight className="w-4 h-4" /></Button></Link>
                        </div>
                    </div>
                </div>
            </section>
