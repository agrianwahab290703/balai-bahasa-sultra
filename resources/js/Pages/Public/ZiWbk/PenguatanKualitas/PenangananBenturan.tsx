...
import { 
    ChevronRight, ArrowLeft, Scale, FileText, FolderOpen, CheckCircle2, Star, X, Loader2, ExternalLink, ChevronDown, Search, Megaphone, CheckSquare, ClipboardCheck, FileCheck
} from 'lucide-react';
...
const documentIcons = [Search, Megaphone, CheckSquare, ClipboardCheck, FileCheck];
                ...
                <div className="flex items-center justify-between px-6 py-4 border-b border-gray-100 bg-gradient-to-r from-slate-50 to-white">
                    <div className="flex items-center gap-3">
                        ...
                        <div>
                            ...
                            <p className="text-sm text-gray-500">Dokumen Penanganan Benturan Kepentingan</p>
                        </div>
                    </div>
...
const DocumentCard = ({ document, index, onViewDocuments }: { document: DocumentItem; index: number; onViewDocuments: (doc: DocumentItem) => void; }) => {
    ...
    const colorSchemes = [
        ...
        { bg: 'from-lime-500 to-lime-600', shadow: 'shadow-lime-500/25', light: 'bg-lime-50', text: 'text-lime-600' },
...
export default function PenangananBenturan({ documents }: Props) {
    ...
    return (
        <PublicLayout title="Penanganan Benturan Kepentingan - ZI-WBK" description="Penanganan Benturan Kepentingan dalam Penguatan Kualitas Pelayanan Publik">
                        ...
                        <div className="flex items-start gap-6">
                            ...
                            <div>
                                ...
                                <h1 className="text-3xl font-bold text-white sm:text-4xl lg:text-5xl mb-4">
                                    Penanganan <span className="font-display italic text-yellow-400">Benturan</span>
                                </h1>
                                <p className="text-lg text-amber-100/90 max-w-2xl leading-relaxed">
                                    Penanganan benturan kepentingan untuk menjaga integritas pelayanan.
                                </p>
                            </div>
                        </div>
                    </div>
                            ...
                            <Card className="border-0 shadow-lg bg-gradient-to-br from-amber-50 to-white overflow-hidden">
                                <CardContent className="p-6 lg:p-8">
                                    <div className="flex items-start gap-4">
                                        ...
                                        <div>
                                            <h2 className="text-xl font-bold text-gray-900 mb-2">Dokumen Penanganan Benturan Kepentingan</h2>
                                            <p className="text-gray-600 leading-relaxed">
                                                Dokumen terkait identifikasi dan penanganan benturan kepentingan.
                                            </p>
                                        </div>
                                    </div>
                                </CardContent>
                            ...
                            <Card className="border-0 shadow-lg bg-gradient-to-br from-gray-50 to-white">
                                <CardContent className="p-6">
                                    <div className="flex items-start gap-4">
                                        ...
                                        <div>
                                            <h3 className="font-semibold text-gray-900 mb-1">Integritas Terjaga</h3>
                                            <p className="text-sm text-gray-600 leading-relaxed">
                                                Penanganan benturan kepentingan yang baik menjamin objektivitas dan integritas pelayanan.
                                            </p>
                                        </div>
                                    </div>
                                </CardContent>
                ...
                <div className="container mx-auto px-4">
                    <div className="max-w-4xl mx-auto">
                        <div className="flex flex-col sm:flex-row items-center justify-between gap-4">
                            <Link href="/zi-wbk/penguatan-kualitas-pelayanan-publik/penerapan-spip"><Button variant="outline" className="gap-2"><ArrowLeft className="w-4 h-4" />Penerapan SPIP</Button></Link>
                            <Link href="/zi-wbk"><Button className="gap-2 bg-amber-600 hover:bg-amber-700">Kembali ke ZI-WBK<ChevronRight className="w-4 h-4" /></Button></Link>
                        </div>
                    </div>
                </div>
            </section>
