...
import { 
    ChevronRight, ArrowLeft, ScrollText, FileText, FolderOpen, CheckCircle2, Star, X, Loader2, ExternalLink, ChevronDown, FileCheck, Megaphone, RefreshCw, Globe
} from 'lucide-react';
...
const documentIcons = [FileCheck, Megaphone, RefreshCw, Globe];
                ...
                <div className="flex items-center justify-between px-6 py-4 border-b border-gray-100 bg-gradient-to-r from-slate-50 to-white">
                    <div className="flex items-center gap-3">
                        ...
                        <div>
                            ...
                            <p className="text-sm text-gray-500">Dokumen Standar Pelayanan</p>
                        </div>
                    </div>
...
export default function StandarPelayanan({ documents }: Props) {
    const [selectedDocument, setSelectedDocument] = useState<DocumentItem | null>(null);

    return (
        <PublicLayout title="Standar Pelayanan - ZI-WBK" description="Standar Pelayanan dalam Penguatan Kualitas Pelayanan Publik">
                ...
                <div className="container relative mx-auto px-4">
                    <div className="max-w-4xl mx-auto">
                        <div className="flex items-center gap-2 text-violet-200 mb-6 text-sm flex-wrap">
                            ...
                            <ChevronRight className="h-4 w-4" />
                            <span className="text-white">Standar Pelayanan</span>
                        </div>
                        <div className="flex items-start gap-6">
                            ...
                            <div>
                                <Badge className="mb-4 bg-purple-400/90 text-gray-900 hover:bg-purple-400 font-medium px-4 py-1.5">
                                ...
                                <h1 className="text-3xl font-bold text-white sm:text-4xl lg:text-5xl mb-4">
                                    Standar <span className="font-display italic text-purple-400">Pelayanan</span>
                                </h1>
                                <p className="text-lg text-violet-100/90 max-w-2xl leading-relaxed">
                                    Kebijakan dan standar pelayanan publik yang terukur dan transparan.
                                </p>
                            </div>
                        </div>
                    </div>
                            ...
                            <Card className="border-0 shadow-lg bg-gradient-to-br from-violet-50 to-white overflow-hidden">
                                <CardContent className="p-6 lg:p-8">
                                    <div className="flex items-start gap-4">
                                        ...
                                        <div>
                                            <h2 className="text-xl font-bold text-gray-900 mb-2">Dokumen Standar Pelayanan</h2>
                                            <p className="text-gray-600 leading-relaxed">
                                                Dokumen terkait kebijakan dan standar pelayanan publik.
                                            </p>
                                        </div>
                                    </div>
                                </CardContent>
                            ...
                            <Card className="border-0 shadow-lg bg-gradient-to-br from-gray-50 to-white">
                                <CardContent className="p-6">
                                    <div className="flex items-start gap-4">
                                        ...
                                        <div>
                                            <h3 className="font-semibold text-gray-900 mb-1">Standar Terukur</h3>
                                            <p className="text-sm text-gray-600 leading-relaxed">
                                                Standar pelayanan yang jelas menjamin kualitas dan konsistensi layanan kepada masyarakat.
                                            </p>
                                        </div>
                                    </div>
                                </CardContent>
                ...
                <div className="container mx-auto px-4">
                    <div className="max-w-4xl mx-auto">
                        <div className="flex flex-col sm:flex-row items-center justify-between gap-4">
                            <Link href="/zi-wbk/penguatan-kualitas-pelayanan-publik/penilaian-kepuasan"><Button variant="outline" className="gap-2"><ArrowLeft className="w-4 h-4" />Penilaian Kepuasan</Button></Link>
                            <Link href="/zi-wbk"><Button className="gap-2 bg-violet-600 hover:bg-violet-700">Kembali ke ZI-WBK<ChevronRight className="w-4 h-4" /></Button></Link>
                        </div>
                    </div>
                </div>
            </section>
