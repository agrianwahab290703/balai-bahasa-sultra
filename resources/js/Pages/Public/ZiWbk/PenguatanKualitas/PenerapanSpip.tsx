...
import { 
    ChevronRight, ArrowLeft, ShieldCheck, FileText, FolderOpen, CheckCircle2, Star, X, Loader2, ExternalLink, ChevronDown, Building2, AlertTriangle, Settings, MessageCircle, FileDown
} from 'lucide-react';
...
const documentIcons = [Building2, AlertTriangle, Settings, MessageCircle, FileDown];
                ...
                <div className="flex items-center justify-between px-6 py-4 border-b border-gray-100 bg-gradient-to-r from-slate-50 to-white">
                    <div className="flex items-center gap-3">
                        ...
                        <div>
                            ...
                            <p className="text-sm text-gray-500">Dokumen Penerapan SPIP</p>
                        </div>
                    </div>
                ...
                <div className="p-6 cursor-pointer" onClick={() => setIsExpanded(!isExpanded)}>
                    <div className="flex items-start gap-4">
                        ...
                        <div className="flex-1 min-w-0">
                            ...
                            <h3 className="text-base lg:text-lg font-semibold text-gray-900 leading-relaxed group-hover:text-indigo-600 transition-colors">{document.title}</h3>
...
export default function PenerapanSpip({ documents }: Props) {
    ...
    return (
        <PublicLayout title="Penerapan SPIP - ZI-WBK" description="Penerapan Sistem Pengendalian Intern Pemerintah dalam Penguatan Kualitas Pelayanan Publik">
                        ...
                        <div className="flex items-start gap-6">
                            ...
                            <div>
                                ...
                                <h1 className="text-3xl font-bold text-white sm:text-4xl lg:text-5xl mb-4">
                                    Penerapan <span className="font-display italic text-blue-400">SPIP</span>
                                </h1>
                                <p className="text-lg text-indigo-100/90 max-w-2xl leading-relaxed">
                                    Sistem Pengendalian Intern Pemerintah untuk pengelolaan risiko dan pengendalian.
                                </p>
                            </div>
                        </div>
                    </div>
                            ...
                            <Card className="border-0 shadow-lg bg-gradient-to-br from-indigo-50 to-white overflow-hidden">
                                <CardContent className="p-6 lg:p-8">
                                    <div className="flex items-start gap-4">
                                        ...
                                        <div>
                                            <h2 className="text-xl font-bold text-gray-900 mb-2">Dokumen Penerapan SPIP</h2>
                                            <p className="text-gray-600 leading-relaxed">
                                                Dokumen terkait Sistem Pengendalian Intern Pemerintah.
                                            </p>
                                        </div>
                                    </div>
                                </CardContent>
                            ...
                            <Card className="border-0 shadow-lg bg-gradient-to-br from-gray-50 to-white">
                                <CardContent className="p-6">
                                    <div className="flex items-start gap-4">
                                        ...
                                        <div>
                                            <h3 className="font-semibold text-gray-900 mb-1">Pengendalian Intern</h3>
                                            <p className="text-sm text-gray-600 leading-relaxed">
                                                SPIP memastikan tercapainya tujuan organisasi melalui pengendalian yang efektif.
                                            </p>
                                        </div>
                                    </div>
                                </CardContent>
                ...
                <div className="container mx-auto px-4">
                    <div className="max-w-4xl mx-auto">
                        <div className="flex flex-col sm:flex-row items-center justify-between gap-4">
                            <Link href="/zi-wbk/penguatan-kualitas-pelayanan-publik/standar-pelayanan"><Button variant="outline" className="gap-2"><ArrowLeft className="w-4 h-4" />Standar Pelayanan</Button></Link>
                            <Link href="/zi-wbk/penguatan-kualitas-pelayanan-publik/penanganan-benturan"><Button className="gap-2 bg-indigo-600 hover:bg-indigo-700">Penanganan Benturan<ChevronRight className="w-4 h-4" /></Button></Link>
                        </div>
                    </div>
                </div>
            </section>
            {selectedDocument && selectedDocument.folderId !== 'PDF_LINK' && <DocumentViewer folderId={selectedDocument.folderId} title={selectedDocument.title} onClose={() => setSelectedDocument(null)} />}
        </PublicLayout>
    );
}
