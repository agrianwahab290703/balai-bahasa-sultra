...
interface KeterbukaanInformasiProps {
    documents: DocumentItem[];
}

const documentIcons = [Eye, ClipboardCheck];
                ...
                <div className="flex items-center justify-between px-6 py-4 border-b border-gray-100 bg-gradient-to-r from-slate-50 to-white">
                    <div className="flex items-center gap-3">
                        ...
                        <div>
                            ...
                            <p className="text-sm text-gray-500">Dokumen Keterbukaan Informasi</p>
                        </div>
                    </div>
...
export default function KeterbukaanInformasi({ documents }: KeterbukaanInformasiProps) {
    const [selectedDocument, setSelectedDocument] = useState<DocumentItem | null>(null);

    return (
        <PublicLayout title="Keterbukaan Informasi Publik - ZI-WBK" description="Keterbukaan Informasi Publik dalam Penguatan Tata Laksana">
                ...
                <div className="container relative mx-auto px-4">
                    <div className="max-w-4xl mx-auto">
                        <div className="flex items-center gap-2 text-blue-200 mb-6 text-sm flex-wrap">
                            ...
                            <ChevronRight className="h-4 w-4" />
                            <span className="text-white">Keterbukaan Informasi</span>
                        </div>
                        ...
                        <div className="flex items-start gap-6">
                            ...
                            <div>
                                ...
                                <h1 className="text-3xl font-bold text-white sm:text-4xl lg:text-5xl mb-4">
                                    Keterbukaan Informasi <span className="font-display italic text-yellow-400">Publik</span>
                                </h1>
                                <p className="text-lg text-blue-100/90 max-w-2xl leading-relaxed">
                                    Implementasi kebijakan keterbukaan informasi publik dan monitoring evaluasinya.
                                </p>
                            </div>
                        </div>
                    </div>
                            ...
                            <Card className="border-0 shadow-lg bg-gradient-to-br from-blue-50 to-white overflow-hidden">
                                <CardContent className="p-6 lg:p-8">
                                    <div className="flex items-start gap-4">
                                        ...
                                        <div>
                                            <h2 className="text-xl font-bold text-gray-900 mb-2">Dokumen Keterbukaan Informasi</h2>
                                            <p className="text-gray-600 leading-relaxed">
                                                Dokumen terkait kebijakan dan evaluasi keterbukaan informasi publik. Klik untuk melihat detail.
                                            </p>
                                        </div>
                                    </div>
                                </CardContent>
                            ...
                            <Card className="border-0 shadow-lg bg-gradient-to-br from-gray-50 to-white">
                                <CardContent className="p-6">
                                    <div className="flex items-start gap-4">
                                        ...
                                        <div>
                                            <h3 className="font-semibold text-gray-900 mb-1">Transparansi Informasi</h3>
                                            <p className="text-sm text-gray-600 leading-relaxed">
                                                Keterbukaan informasi publik merupakan salah satu pilar penting dalam tata kelola pemerintahan yang baik dan akuntabel.
                                            </p>
                                        </div>
                                    </div>
                                </CardContent>
                ...
                <div className="container mx-auto px-4">
                    <div className="max-w-4xl mx-auto">
                        <div className="flex flex-col sm:flex-row items-center justify-between gap-4">
                            <Link href="/zi-wbk">
                                <Button variant="outline" className="gap-2"><ArrowLeft className="w-4 h-4" />ZI-WBK</Button>
                            </Link>
                            <Link href="/zi-wbk/penguatan-tata-laksana/sop-kegiatan-utama">
                                <Button className="gap-2 bg-blue-600 hover:bg-blue-700">SOP Kegiatan Utama<ChevronRight className="w-4 h-4" /></Button>
                            </Link>
                        </div>
                    </div>
                </div>
