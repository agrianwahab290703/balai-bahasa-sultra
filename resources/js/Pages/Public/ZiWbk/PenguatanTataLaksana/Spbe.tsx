...
const documentIcons = [BarChart3, Users, Headphones, ClipboardCheck];
                ...
                <div className="flex items-center justify-between px-6 py-4 border-b border-gray-100 bg-gradient-to-r from-slate-50 to-white">
                    <div className="flex items-center gap-3">
                        ...
                        <div>
                            ...
                            <p className="text-sm text-gray-500">Dokumen SPBE</p>
                        </div>
                    </div>
                ...
                <div className="p-6 cursor-pointer" onClick={() => setIsExpanded(!isExpanded)}>
                    <div className="flex items-start gap-4">
                        ...
                        <div className="flex-1 min-w-0">
                            ...
                            <h3 className="text-base lg:text-lg font-semibold text-gray-900 leading-relaxed group-hover:text-violet-600 transition-colors">{document.title}</h3>
...
export default function Spbe({ documents }: SpbeProps) {
    const [selectedDocument, setSelectedDocument] = useState<DocumentItem | null>(null);

    return (
        <PublicLayout title="SPBE - ZI-WBK" description="Sistem Pemerintahan Berbasis Elektronik">
            <section className="relative bg-gradient-to-br from-[#7c3aed] via-[#6d28d9] to-[#5b21b6] py-16 lg:py-20 overflow-hidden">
                <div className="absolute inset-0 overflow-hidden">
                    <div className="absolute -top-24 -right-24 w-96 h-96 bg-yellow-400/10 rounded-full blur-3xl" />
                    <div className="absolute -bottom-32 -left-32 w-[500px] h-[500px] bg-violet-300/20 rounded-full blur-3xl" />
                </div>
                ...
                <div className="container relative mx-auto px-4">
                    <div className="max-w-4xl mx-auto">
                        <div className="flex items-center gap-2 text-violet-200 mb-6 text-sm flex-wrap">
                            ...
                            <ChevronRight className="h-4 w-4" />
                            <span className="text-white">SPBE</span>
                        </div>
                        ...
                        <div className="flex items-start gap-6">
                            ...
                            <div>
                                ...
                                <h1 className="text-3xl font-bold text-white sm:text-4xl lg:text-5xl mb-4">
                                    Sistem Pemerintahan Berbasis <span className="font-display italic text-yellow-400">Elektronik</span>
                                </h1>
                                <p className="text-lg text-violet-100/90 max-w-2xl leading-relaxed">
                                    Pemanfaatan teknologi informasi dalam pengukuran kinerja, manajemen SDM, dan pelayanan publik.
                                </p>
                            </div>
                        </div>
                    </div>
                            ...
                            <Card className="border-0 shadow-lg bg-gradient-to-br from-violet-50 to-white overflow-hidden">
                                <CardContent className="p-6 lg:p-8">
                                    <div className="flex items-start gap-4">
                                        ...
                                        <div>
                                            <h2 className="text-xl font-bold text-gray-900 mb-2">Dokumen SPBE</h2>
                                            <p className="text-gray-600 leading-relaxed">
                                                Dokumen pemanfaatan teknologi informasi dalam tata kelola pemerintahan. Klik untuk melihat detail.
                                            </p>
                                        </div>
                                    </div>
                                </CardContent>
                        ...
                        <div className="mt-10 grid sm:grid-cols-4 gap-4">
                            <Card className="border-0 shadow-md bg-gradient-to-br from-violet-50 to-white">
                                <CardContent className="p-5 text-center">
                                    ...
                                    <p className="text-sm font-medium text-gray-600">Kinerja</p>
                                    <p className="text-xs text-gray-400 mt-1">Pengukuran TI</p>
                                </CardContent>
                            </Card>
                            <Card className="border-0 shadow-md bg-gradient-to-br from-purple-50 to-white">
                                <CardContent className="p-5 text-center">
                                    <Users className="w-8 h-8 text-purple-600 mx-auto mb-2" />
                                    <p className="text-sm font-medium text-gray-600">SDM</p>
                                    <p className="text-xs text-gray-400 mt-1">Manajemen digital</p>
                                </CardContent>
                            </Card>
                            <Card className="border-0 shadow-md bg-gradient-to-br from-indigo-50 to-white">
                                <CardContent className="p-5 text-center">
                                    ...
                                    <p className="text-xs text-gray-400 mt-1">Publik online</p>
                                </CardContent>
                            </Card>
                            <Card className="border-0 shadow-md bg-gradient-to-br from-fuchsia-50 to-white">
                                <CardContent className="p-5 text-center">
                                    <ClipboardCheck className="w-8 h-8 text-fuchsia-600 mx-auto mb-2" />
                                    <p className="text-sm font-medium text-gray-600">Monitoring</p>
                                    <p className="text-xs text-gray-400 mt-1">Evaluasi TI</p>
                                </CardContent>
                            </Card>
                        </div>
                            ...
                            <Card className="border-0 shadow-lg bg-gradient-to-br from-gray-50 to-white">
                                <CardContent className="p-6">
                                    <div className="flex items-start gap-4">
                                        ...
                                        <div>
                                            <h3 className="font-semibold text-gray-900 mb-1">Transformasi Digital</h3>
                                            <p className="text-sm text-gray-600 leading-relaxed">
                                                SPBE mendorong efisiensi, transparansi, dan akuntabilitas dalam penyelenggaraan pemerintahan melalui pemanfaatan teknologi informasi.
                                            </p>
                                        </div>
                                    </div>
                                </CardContent>
                ...
                <div className="container mx-auto px-4">
                    <div className="max-w-4xl mx-auto">
                        <div className="flex flex-col sm:flex-row items-center justify-between gap-4">
                            <Link href="/zi-wbk/penguatan-tata-laksana/sop-kegiatan-utama">
                                <Button variant="outline" className="gap-2"><ArrowLeft className="w-4 h-4" />SOP Kegiatan Utama</Button>
                            </Link>
                            <Link href="/zi-wbk">
                                <Button className="gap-2 bg-violet-600 hover:bg-violet-700">Kembali ke ZI-WBK<ChevronRight className="w-4 h-4" /></Button>
                            </Link>
                        </div>
                    </div>
                </div>
