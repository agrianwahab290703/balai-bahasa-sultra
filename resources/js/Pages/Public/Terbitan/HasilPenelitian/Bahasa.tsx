...
import { BookOpen, Download, ExternalLink, AlertTriangle, Sparkles, ArrowRight, FileText, Calendar, Tag, Microscope, GraduationCap, BookMarked } from 'lucide-react';
...
export default function Bahasa({ researches, disclaimer }: Props) {
    ...
    return (
        <PublicLayout>
            <Head title="Hasil Penelitian Bahasa - Terbitan" />

            {/* Hero Section */}
            <section className="relative bg-gradient-to-br from-blue-900 via-cyan-900 to-slate-900 py-20 lg:py-28 overflow-hidden">
                {/* Decorative elements */}
                <div className="absolute inset-0 opacity-20">
                    ...
                    <div className="absolute top-1/2 left-1/2 w-64 h-64 bg-teal-400 rounded-full filter blur-3xl animate-pulse delay-500"></div>
                </div>
                ...
                <div className="container mx-auto px-4 relative z-10">
                    <div className="text-center max-w-4xl mx-auto">
                        {/* Icon */}
                        <div className="inline-flex items-center justify-center w-20 h-20 bg-gradient-to-br from-blue-400 to-cyan-500 rounded-2xl mb-8 shadow-xl shadow-blue-500/30">
                        ...
                        <p className="text-lg md:text-xl text-blue-100 mb-8 max-w-3xl mx-auto leading-relaxed">
                            Kumpulan hasil penelitian kebahasaan dari Balai Bahasa Provinsi Sulawesi Tenggara 
                            yang mengkaji berbagai aspek penggunaan bahasa Indonesia.
                        </p>

                        {/* Breadcrumb */}
                        <nav className="flex justify-center items-center gap-2 text-sm text-blue-200 flex-wrap">
                            <a href="/" className="hover:text-white transition-colors">Beranda</a>
                            <span className="text-blue-400">/</span>
                            <span className="text-blue-300">Terbitan</span>
                            <span className="text-blue-400">/</span>
                            <span className="text-blue-300">Hasil Penelitian</span>
                            <span className="text-blue-400">/</span>
                            <span className="text-white font-medium">Bahasa</span>
                        </nav>
                    </div>
                </div>
                ...
                <div className="container mx-auto px-4">
                    <div className="flex flex-wrap justify-center gap-8 md:gap-16">
                        ...
                        <div className="flex items-center gap-3">
                            ...
                            <div>
                                <p className="text-2xl font-bold text-slate-800">Bahasa</p>
                ...
                <div className="container mx-auto px-4">
                    ...
                    <div className="text-center mb-12">
                        <div className="inline-flex items-center gap-2 bg-blue-100 text-blue-700 px-4 py-2 rounded-full text-sm font-medium mb-4">
                            ...
                            Koleksi Penelitian Bahasa
                        </div>
                        <h2 className="text-3xl md:text-4xl font-bold text-slate-800 mb-4">
                            Publikasi Ilmiah Kebahasaan
                        </h2>
                        <p className="text-slate-600 max-w-2xl mx-auto">
                            Unduh dan baca hasil penelitian tentang penggunaan bahasa Indonesia di Sulawesi Tenggara
                        </p>
                    </div>
                            ...
                            <div className="flex flex-col md:flex-row items-start gap-6">
                                ...
                                <div>
                                    <h3 className="text-xl font-bold text-slate-800 mb-3">
                                        Tentang Penelitian Bahasa
                                    </h3>
                                    <p className="text-slate-600 leading-relaxed mb-4">
                                        Penelitian bahasa merupakan kegiatan ilmiah yang dilakukan oleh Balai Bahasa 
                                        Provinsi Sulawesi Tenggara untuk mengkaji berbagai aspek penggunaan bahasa Indonesia 
                                        di masyarakat. Hasil penelitian ini dapat dijadikan rujukan bagi pengembangan 
                                        bahasa Indonesia yang baik dan benar.
                                    </p>
                                    <ul className="text-slate-600 text-sm space-y-2">
                                        <li className="flex items-center gap-2">
                                            <span className="w-1.5 h-1.5 bg-blue-500 rounded-full"></span>
                                            Mengkaji penggunaan bahasa di media massa
                                        </li>
                                        <li className="flex items-center gap-2">
                                            <span className="w-1.5 h-1.5 bg-blue-500 rounded-full"></span>
                                            Menganalisis ejaan dan tata bahasa
                                        </li>
                                        <li className="flex items-center gap-2">
                                            <span className="w-1.5 h-1.5 bg-blue-500 rounded-full"></span>
                                            Meneliti sikap bahasa masyarakat dan pendidik
                                        </li>
                                    </ul>
                                </div>
                            </div>
            ...
            <section className="py-16 bg-gradient-to-br from-blue-900 via-cyan-900 to-slate-900 relative overflow-hidden">
                ...
                <div className="container mx-auto px-4 relative z-10 text-center">
                    <h3 className="text-2xl md:text-3xl font-bold text-white mb-4">
                        Jelajahi Penelitian Sastra
                    </h3>
                    <p className="text-blue-200 mb-8 max-w-xl mx-auto">
                        Temukan juga koleksi hasil penelitian sastra dari Balai Bahasa Sulawesi Tenggara
                    </p>
                    <a
                        href="/terbitan/hasil-penelitian/sastra"
                        className="inline-flex items-center gap-3 bg-white text-blue-900 px-8 py-4 rounded-xl font-semibold hover:bg-blue-50 transition-all duration-300"
                    >
                        Lihat Penelitian Sastra
